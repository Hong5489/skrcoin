...
"""Verify that starting skrcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start skrcoin with -h for help text")
        ...
        self.log.info("Start skrcoin with -version for version information")
        ...
        self.log.info("Start skrcoind with -fakearg to make sure it does not start")
