...
const char * const BITCOIN_CONF_FILENAME = "skrcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Skrcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Skrcoin";
#else
    // Unix
    return pathRet / ".skrcoin";
#endif
#endif
}
