...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " skrcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  skrcoin-tx [options] <hex-tx> [commands]  Update hex-encoded skrcoin transaction\n" +
            "or:     skrcoin-tx [options] -create [commands]   Create hex-encoded skrcoin transaction\n" +
            "\n";
