# Support for Output Descriptors in Skrcoin Core

Since Skrcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Skrcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Skrcoin Core wallets, a convenience function `combo` is
